...
\centering 本报告记录第 4 周课堂综合题 q13--q16 的实际执行结果。内容覆盖本地质量门禁、Make 增量构建、API 数据报告，以及 Python 软件包的测试、构建与 Git 交付。
\end{tcolorbox}
\vspace{.55cm}
...
\end{figure}
\begin{summarybox}{结果说明}临时错误时实际输出为 \texttt{Hello, name!}，与期望的 \texttt{Hello, Ada!} 不一致，\texttt{make check} 返回非零状态；恢复问候函数后，两项测试均通过，说明正常姓名与空白姓名两个行为均得到验证。\end{summarybox}
\clearpage
\begin{figure}[H]\centering
...
\end{lstlisting}
\begin{figure}[H]\centering
\includegraphics[width=.91\textwidth,height=.30\textheight,keepaspectratio]{assets/afterclass-q01-format.png}
\caption{课后练习 1：Ruff 格式化与只检查模式的可复现实验记录}
\end{figure}
...
\end{lstlisting}
\begin{figure}[H]\centering
\includegraphics[width=.91\textwidth,height=.30\textheight,keepaspectratio]{assets/afterclass-q02-lint.png}
\caption{课后练习 2：Ruff 报告并自动修复未使用导入的可复现实验记录}
\end{figure}
...
\end{lstlisting}
\begin{figure}[H]\centering
\includegraphics[width=.91\textwidth,height=.28\textheight,keepaspectratio]{assets/afterclass-q03-tests.png}
\caption{课后练习 3：问候函数边界条件测试的可复现实验记录}
\end{figure}
...
\end{lstlisting}
\begin{figure}[H]\centering
\includegraphics[width=.91\textwidth,height=.31\textheight,keepaspectratio]{assets/afterclass-q04-coverage.png}
\caption{课后练习 4：测试覆盖率与 HTML 报告生成的可复现实验记录}
\end{figure}
...
\end{lstlisting}
\begin{figure}[H]\centering
\includegraphics[width=.91\textwidth,height=.30\textheight,keepaspectratio]{assets/afterclass-q05-precommit.png}
\caption{课后练习 5：pre-commit 质量门禁的可复现实验记录}
\end{figure}
...
\end{lstlisting}
\begin{figure}[H]\centering
\includegraphics[width=.91\textwidth,height=.30\textheight,keepaspectratio]{assets/afterclass-q06-ci.png}
\caption{课后练习 6：持续集成质量工作流的可复现实验记录}
\end{figure}
...
\end{lstlisting}
\begin{figure}[H]\centering
\includegraphics[width=.91\textwidth,height=.30\textheight,keepaspectratio]{assets/afterclass-q07-make.png}
\caption{课后练习 7：Make 统一执行质量检查的可复现实验记录}
\end{figure}
...
\end{lstlisting}
\begin{figure}[H]\centering
\includegraphics[width=.91\textwidth,height=.30\textheight,keepaspectratio]{assets/afterclass-q08-regex.png}
\caption{课后练习 8：检索危险 shell 调用的可复现实验记录}
\end{figure}
...
\end{lstlisting}
\begin{figure}[H]\centering
\includegraphics[width=.91\textwidth,height=.30\textheight,keepaspectratio]{assets/afterclass-q09-replace.png}
\caption{课后练习 9：精确替换 Markdown 项目符号的可复现实验记录}
\end{figure}
...
\end{lstlisting}
\begin{figure}[H]\centering
\includegraphics[width=.91\textwidth,height=.30\textheight,keepaspectratio]{assets/afterclass-q10-json.png}
\caption{课后练习 10：JSON 名称提取与解析器对照的可复现实验记录}
\end{figure}
